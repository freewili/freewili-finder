/**
 * @file c_api_basic_usage_pure_c.c
 * @brief Pure C example demonstrating how to use the fwfinder C API
 *
 ...
 *
 * This is a pure C implementation (no C++ features).
 */
...
int main(void) {
    printf("FreeWili Device Finder C API Example (Pure C)\n");
    printf("=============================================\n\n");
